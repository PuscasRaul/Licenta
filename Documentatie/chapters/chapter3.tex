...
În mod concret,~\cite{HoughTransformation} propun un sistem în care etapa de localizare se folosește de transformarea Hough pentru a corecta variația de înclinare/ rotație a lp-ului. Această aliniere permite utilizarea proiecțiilor orizontale pentru determinarea rândurilor de text.
